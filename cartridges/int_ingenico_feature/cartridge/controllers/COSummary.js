...
function start(context) {
    ...
    if (!COBilling.ValidatePayment(cart)) {
        ...
        var viewContext = require('sitegenesis_storefront_core/cartridge/scripts/common/extend').immutable(context, {
            Basket: cart.object
        });
 ...
 */
function submit() {
    // dw.system.Logger.getLogger("Ingenico").warn("GOT HERE OVERLOADED CONTROLLER: COSumary");
